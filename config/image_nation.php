...
$config['source_directory'] = 'upload'; // if there is a default source directory for the images; the source directory should be relative to the main index.php
$config['parent_directory'] = 'upload'; // if there is a default parent directory for the images; if not, leave empty and it will be used the source directory as parent directory
